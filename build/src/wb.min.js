...
sendSpeedByMobile(b){"mobTab"===virtualclass.system.device&&ioAdapter.sendSpeed(b)},isRefreshMode(){return virtualclass.config.makeWebSocketReady},triggerFinalizeTextIfAny(b){},checkUserRole(){return virtualclass.isPlayMode?"t"===wbUser.orginalUserRole:"t"===virtualclass.gObj.uRole||"p"===virtualclass.gObj.uRole},closeElement(b){b.classList.contains("open")&&(b.classList.remove("open"),b.classList.add("close"))},canvasDimensionFromPixel(b){const a=parseFloat(c.getComputedStyle(b).width);b=parseFloat(c.getComputedStyle(b).height);
